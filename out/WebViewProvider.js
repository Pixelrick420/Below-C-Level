...
class WebViewProvider {
    ...
    static createOrShow(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel('belowCLevel', 'Below C Level', column || vscode.ViewColumn.One, {
            enableScripts: true,
        ...
        panel.webview.onDidReceiveMessage(message => {
            switch (message.command) {
                case 'updateSetting':
                    vscode.workspace.getConfiguration('belowCLevel').update(message.setting, message.value, vscode.ConfigurationTarget.Global);
